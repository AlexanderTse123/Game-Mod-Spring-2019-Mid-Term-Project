...
private:
	...
	stateResult_t		State_Smoke				( const stateParms_t& parms );
...
CLASS_STATES_DECLARATION ( rvWeaponBlaster )
	...
	STATE ( "Smoke",						rvWeaponBlaster::State_Smoke)
END_CLASS_STATES
...
/*
================
rvWeaponBlaster::State_Smoke
================
*/
stateResult_t rvWeaponBlaster::State_Smoke ( const stateParms_t& parms ) {
	for (int i = 0; i < 10; i++) {
		PlayEffect("fx_impact", barrelJointView, false);
	}
	return SRESULT_DONE;
}